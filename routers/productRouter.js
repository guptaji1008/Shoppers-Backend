...
router.route('/:id').get(asyncHandler(getSingleProduct)).put(upload.single('image'), protect, admin, asyncHandler(updateProduct)).delete(protect, admin, asyncHandler(deleteProduct))
